        ...
        @forelse ($stories as $story)
          <div class="bg-white rounded-2xl shadow-xl p-5 flex flex-col group transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
            ...
            <div class="relative w-full aspect-[3/4] bg-gray-200 rounded-lg overflow-hidden mb-4">
              ...
              @else
                {{-- PERBAIKAN: Karakter 'Z' dihapus dari sebelum @else --}}
            ...
            {{-- Tombol Detail --}}
            <div class="mt-auto"> 
              {{-- Ganti 'karya.show' jika Anda punya nama route detail --}}
              <a href="/ceritakomunitas/{{ $story->id }}" class="block w-full bg-[#05284C] text-white text-center rounded-lg py-2.5 px-4 font-semibold text-sm hover:bg-opacity-90 transition-all duration-300">
                  Lihat Detail
              </a>
            </div>
          </div>
