      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        @forelse ($books as $book)
          {{-- 
             ...
             2. Menambahkan wire:navigate untuk navigasi cepat.
          --}}
          <a href="{{ route('bukuresmi.show', $book->id) }}" 
             wire:navigate
            ...
            {{-- Judul dan Penulis --}}
            <div class="mb-4"> 
              <h3 class="font-bold text-lg text-gray-900 truncate group-hover:text-[#05284C] transition-colors" title="{{ $book->judul }}">
                {{ $book->judul }}
              </h3>
            ...
            <div class="relative w-full aspect-[3/4] bg-gray-200 rounded-lg overflow-hidden mb-4 border border-gray-100">
              ...
              @endif
               ...
               {{-- Overlay Icon Detail saat hover --}}
            ...
            <div class="mt-auto flex justify-between items-center pt-2">
               <span class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Lihat Sumber</span>
