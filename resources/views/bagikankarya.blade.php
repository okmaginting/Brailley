...
@section('content')
  ...
  {{-- ======================= --}}
  {{-- MODAL POP-UP SUKSES (Diambil dari kode template kedua Anda) --}}
  {{-- ======================= --}}
  @if (session('success'))
  ...
  {{-- ======================= --}}
  {{-- KONTEN UTAMA HALAMAN (Diambil dari kode pertama Anda) --}}
  {{-- ======================= --}}
    ...
    <div class="bg-[#F1EFEC] rounded-[40px] w-full max-w-5xl p-16 text-center shadow-lg">
      ...
      @auth
        ...
        <div class="flex justify-center gap-6">
          <a href="{{ route('karya.create') }}" class="bg-[#05284C] text-white px-8 py-4 rounded-2xl text-lg font-bold hover:bg-opacity-90 transition-all shadow-md hover:shadow-xl flex items-center gap-3">
      ...
      @guest
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-6">
          {{-- Tombol Login --}}
          <a href="{{ route('login') }}" class="bg-[#05284C] text-white px-8 py-4 rounded-2xl text-lg font-bold hover:bg-opacity-90 transition-all shadow-md hover:shadow-xl flex items-center justify-center gap-3">
            <i data-lucide="log-in" class="w-6 h-6"></i>
            Login
          </a>
          {{-- Tombol Register --}}
          <a href="{{ route('register') }}" class="bg-gray-600 text-white px-8 py-4 rounded-2xl text-lg font-bold hover:bg-gray-700 transition-all shadow-md hover:shadow-xl flex items-center justify-center gap-3">
